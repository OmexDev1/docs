...
<AccordionGroup>
    ...
    <Accordion title="Changing the prize">
        ...
        ```javascript Example
        ,giveaway edit prize .../channels/... Omex whitelist
        ```
        </CodeGroup>
    </Accordion>
...
<AccordionGroup>
    ...
    <Accordion title="Changing the thumbnail">
        ...
        ```javascript Example
        ,giveaway edit thumbnail .../channels/... https://Omex.bot/Omex.png
        ```
    ...
    <Accordion title="Changing the image">
        ...
        ```javascript Example
        ,giveaway edit image .../channels/... https://Omex.bot/Omex.png
        ```
...
<AccordionGroup>
    ...
    <Accordion title="Setting a required level">
        ...
        <Warning>This relies on Omex's [leveling system](/configuration/level-rewards), not other bots.</Warning>
        <CodeGroup>
        ```javascript Syntax
