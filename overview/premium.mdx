---
title: "Donator Perks"
description: "Donator perks are rewards given to those who choose to donate to Omex."
icon: "dollar-sign"
---

## How to obtain Donator Perks

Donator perks can be purchased via **server subscriptions** in our
[Support Server](https://discord.gg/Omex), which can be found at the top of the
channel list labeled **Server Shop**.

<Warning>
  Your server prefix is **,** by default. Use **prefix set (prefix)** to customize it.
</Warning>
