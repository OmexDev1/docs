...
Donator perks can be purchased via **server subscriptions** in our [Support Server](https://discord.gg/Omex) which can be found at the top of the channel list labeled as **Server Shop**.
