...
<Info>
  The `#jail-log` channel logs all moderation actions done through Omex (e.g.
...
It's important to set the staff roles in your server to ensure that Omex can identify who has dangerous permissions. This is necessary for the `stripstaff` punishment to work.
