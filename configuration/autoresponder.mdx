...
<Tip>
The `response` parameter can be raw text or an [embed](/resources/Embeds) with dynamic [variables](/resources/variables)
</Tip>
<CodeGroup>
...
,autoresponder add welc, {embed}$vtitle:Welcome$vdescription:Welcome to the server!
```
