...
<AccordionGroup>
  ...
  <Accordion title="Mass mentions">
    ...
    If the message includes any mentions, it caches the message ID. When threshold triggers, it deletes cached mention messages from the last 10 seconds and punishes/logs.
