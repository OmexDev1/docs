...
<AccordionGroup>
  <Accordion title="Mass ban">
    ...
    <Frame>
      <img src="/images/security/antinuke/ban.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
  <Accordion title="Mass kick">
    ...
    <Frame>
      <img src="/images/security/antinuke/kick.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
  <Accordion title="Channel creation">
    ...
    <Frame>
      <img src="/images/security/antinuke/channelcreation.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
  <Accordion title="Channel deletion">
    ...
    <Frame>
      <img src="/images/security/antinuke/channeldeletion.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
  <Accordion title="Role creation">
    ...
    <Frame>
      <img src="/images/security/antinuke/rolecreation.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
  <Accordion title="Role deletion">
    ...
    <Frame>
      <img src="/images/security/antinuke/roledeletion.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
  <Accordion title="Webhooks">
    Triggers on `on_webhooks_update`. Looks for webhook create/delete/update in audit logs. If it triggers and the bot has `Manage Webhooks`, it deletes webhooks in that channel.
    ...
    <Frame>
      <img src="/images/security/antinuke/webhooks.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
  <Accordion title="Mass mentions">
    ...
    <Frame>
      <img src="/images/security/antinuke/mentions.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
  <Accordion title="Dangerous permissions">
    ...
    **2) Dangerous role granted to a member**
    ...
    <Frame>
      <img src="/images/security/antinuke/permissions.png" alt="" style={{ width:"100%" }} />
    </Frame>
    ````
  </Accordion>
</AccordionGroup>
